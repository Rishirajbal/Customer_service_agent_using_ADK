...
from .tools.course_support_agent.agent import course_support_agent
from .tools.order_agent.agent import order_agent
from .tools.policy_agent.agent import policy_agent
from .tools.sales_agent.agent import sales_agent

agent=Agent(
    name="customer_service_agent",
    model="gemini-2.5-flash",
    description="A customer service agent that can help with customer service issues",
    ...
    **Interaction History:**
    ...
    """,
    sub_agents=[course_support_agent,order_agent,policy_agent,sales_agent],
)
